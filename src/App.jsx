...
// //       <div>
// //         <textarea name="input-text" className="bg-white h-30 w-[500px]"/>
// //         <textarea name="input-text" className="bg-white h-30 w-[500px]"/>
// //       </div>
...
//   const [setValue, setSelectValue ] = useState("")
...
//         <h1 className="text-3xl text-zinc-700 font-bold p-4">Text Translator</h1>
//       </div>

//       <div className="flex gap-4 p-4 items-center justify-center flex-col gap-y-5">
//         <textarea name="input-text" className="bg-white h-30 w-[500px] p-2 rounded" border border-slate-700 outline-none rounded-lg text-lg px-5 py-2 onChange={(e) => setTextInput(e.target.value)}/>
//         <textarea name="input-text" className="bg-white h-30 w-[500px] p-2 rounded" border border-slate-700 outline-none rounded-lg text-lg px-5 py-2/>
//       </div>
...
//       <button className="bg-purple-700 text-slate-100 mx-auto w-[500px] py-1 rounded-lg cursor-pointer">Translate</button>
...
//     console.log(response?.data?.translations?.[Number(0)]?.translatedText)
//     setResult(response?.data?.translations?.[Number(0)]?.translatedText)
//   }
//      catch (error) {
//       console.log(error?.message)
//     }
...
//       <button
//         className="bg-purple-700 text-slate-100 w-[500px] py-1 rounded-lg cursor-pointer"
//         onClick={handleTextTranslation}>Translate</button>
//     </div>
//   )
